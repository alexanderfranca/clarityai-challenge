...
def test_ingest_csv_generic_and_consolidate(temp_project):
        ...
        "entities": {
            "boxofficemetrics_domestic_stage": {
                "columns": [
                    ...
                    {"name": "record_hash"},
                    {"name": "movie_key"}, {"name": "title"}, {"name": "year"}, {"name": "domestic_box_office_gross"}
                ]
            }
        }
    }
            ...
            "boxofficemetrics": {
                ...
                "feeds": {
                    "domestic_csv": {
                        ...
                        "record_identity": {"columns": ["title", "year", "domestic_box_office_gross"]},
    ...
    p.write_text("film_name,year_of_release,box_office_gross_usd\nA,2001,10\nA,2001,10\n", encoding="utf-8")
    item = {"provider": "boxofficemetrics", "batch_id": "b1", "feed": "domestic_csv", "file": str(p),
            "source_mod_time": "2025-01-01T00:00:00Z", "file_hash": "h123"}
...
def test_ingest_json_generic(temp_project):
            ...
            "audiencepulse": {
                ...
                "feeds": {
                    "ratings_json": {
                        ...
                        "record_identity": {"columns": ["title", "year", "audience_average_score", "total_audience_ratings"]},
    ...
    j.write_text('{"title": "A", "year":2001,"audience_average_score":9.1,"total_audience_ratings":10}\n', encoding="utf-8")
    item = {"provider": "audiencepulse", "batch_id": "b1", "feed": "ratings_json", "file":str(j),
            "source_mod_time": "2025-01-01T00:00:00Z", "file_hash": "hh"}
