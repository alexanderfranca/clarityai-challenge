...
def test_build_gold_from_silver(temp_project, monkeypatch):
    ...
    df = pd.DataFrame([{
        "movie_key": "k1", "title": "A", "year": 2001,
        "domestic_box_office_gross": 10, "international_box_office_gross": 5,
        "production_budget_usd": 3, "marketing_spend_usd": 2,
        "critic_score_percentage": 90, "audience_score_100": 95
    }])
